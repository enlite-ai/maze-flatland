...
class AddConfToSearchPathPlugin(SearchPathPlugin):
    """Hydra plugin to register additional config packages in the search path.
    ...
    this class during testing. Therefore the actual paths are provided by ``maze_envs.__init__``.
    """

    def manipulate_search_path(self, search_path: ConfigSearchPath) -> None:
        """implement the SearchPathPlugin interface"""
        search_path.append('project', 'pkg://maze.conf')
        search_path.append('project', 'pkg://maze_flatland.conf')
